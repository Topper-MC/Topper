package me.hsgamer.topper.storage.simple.sql;
...
public abstract class SqlStorageSupplier implements DataStorageSupplier {
    ...
    protected SqlStorageSupplier(Driver driver, DatabaseSetting databaseSetting, Function<Setting, SqlClient<?>> clientFunction) {
