...
public final class ComplexValueConverter<T> implements BundleValueConverter<T> {
    ...
    private static class Entry<T> {
        private final BundleValueConverter<Object> converter;
        private final Function<T, Object> getter;
        private final BiFunction<T, Object, T> setter;

        private Entry(BundleValueConverter<Object> converter, Function<T, Object> getter, BiFunction<T, Object, T> setter) {
    ...
    public static class Builder<T> {
        ...
        public <V> Builder<T> entry(BundleValueConverter<V> converter, Function<T, V> getter, BiFunction<T, V, T> setter) {
            BundleValueConverter<Object> objectConverter = (BundleValueConverter<Object>) converter;
